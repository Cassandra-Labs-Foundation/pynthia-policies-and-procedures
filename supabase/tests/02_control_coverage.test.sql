...
-- AU-03 Internal Auditor Independence and Reporting  (in-scope fields: 3, gaps: 0, out-of-scope: 8)
...
-- AU-04 Risk-Based Audit Scope and Frequency  (in-scope fields: 2, gaps: 0, out-of-scope: 11)
...
-- AU-05 Audit Types and Network Assessments  (in-scope fields: 2, gaps: 0, out-of-scope: 8)
...
-- AU-06 Audit Reporting and Work Papers  (in-scope fields: 6, gaps: 0, out-of-scope: 6)
select has_column('core', 'finding', 'description', 'AU-06: finding.description -> finding.description');
select has_column('core', 'finding', 'implementation_date', 'AU-06: finding.implementation_date -> finding.implementation_date');
...
-- AU-07 Finding Tracking and Escalation  (in-scope fields: 11, gaps: 0, out-of-scope: 2)
select has_column('core', 'finding', 'communicated', 'AU-07: finding.communicated -> finding.communicated');
...
-- AU-08 Management Response and Risk Acceptance  (in-scope fields: 9, gaps: 0, out-of-scope: 4)
select has_column('core', 'case', 'audit', 'AU-08: audit_detail.corrective_action -> embedded in case.audit');
select has_column('core', 'finding', 'communicated', 'AU-08: finding.communicated -> finding.communicated');
select has_column('core', 'finding', 'description', 'AU-08: finding.description -> finding.description');
select has_column('core', 'finding', 'implementation_date', 'AU-08: finding.implementation_date -> finding.implementation_date');
...
select has_column('core', 'finding', 'risk_acceptance_package', 'AU-08: finding.risk_acceptance_package -> finding.risk_acceptance_package');
...
-- AU-09 Follow-Up Audits  (in-scope fields: 6, gaps: 0, out-of-scope: 3)
select has_column('core', 'finding', 'closure_evidence', 'AU-09: finding.closure_evidence -> finding.closure_evidence');
select has_column('core', 'finding', 'communicated', 'AU-09: finding.communicated -> finding.communicated');
select has_column('core', 'finding', 'description', 'AU-09: finding.description -> finding.description');
select has_column('core', 'finding', 'implementation_date', 'AU-09: finding.implementation_date -> finding.implementation_date');
...
-- SC-02 Record-Retention Lifecycle Mechanics  (in-scope fields: 7, gaps: 0, out-of-scope: 9)
...
select has_column('core', 'legal_hold', 'schedule_resumed', 'SC-02: legal_hold.schedule_resumed -> legal_hold.schedule_resumed');

-- BA-04 Risk-Weight Schedule  (in-scope fields: 3, gaps: 0, out-of-scope: 9)
...
-- BA-08 Monitoring, Reporting, and Pillar 3 Disclosures  (in-scope fields: 3, gaps: 0, out-of-scope: 16)
select has_column('core', 'training', 'annual_due_at', 'BA-08: training.annual_due_at -> training.annual_due_at');
select has_column('core', 'training', 'capital', 'BA-08: training.capital -> training.capital');
select has_column('core', 'training', 'required_curriculum', 'BA-08: training.required_curriculum -> training.required_curriculum');

-- BSA-01 Governance & Delegation  (in-scope fields: 3, gaps: 0, out-of-scope: 12)
select has_column('core', 'document', 'policy', 'BSA-01: policy_doc.bsa_officer_id -> embedded in document.policy');
select has_column('core', 'document', 'policy', 'BSA-01: policy_doc.raci_registry -> embedded in document.policy');
select has_column('core', 'document', 'policy', 'BSA-01: policy_doc.version -> embedded in document.policy');

-- BSA-02 Enterprise BSA/AML Risk Assessment  (in-scope fields: 7, gaps: 0, out-of-scope: 2)
...
select has_column('core', 'document', 'risk', 'BSA-02: risk_catalog_entry.geography_factors -> embedded in document.risk');
select has_column('core', 'document', 'risk', 'BSA-02: risk_catalog_entry.inherent_score -> embedded in document.risk');
select has_column('core', 'document', 'risk', 'BSA-02: risk_catalog_entry.partner_dependency -> embedded in document.risk');
...
-- BSA-09 Monetary Instruments Log  (in-scope fields: 4, gaps: 0, out-of-scope: 1)
select has_column('core', 'entity', 'name', 'BSA-09: entity.name -> entity.name');
select has_column('core', 'document', 'mi', 'BSA-09: mi_central_log.amount -> embedded in document.mi');
select has_column('core', 'document', 'mi', 'BSA-09: mi_central_log.instrument_type -> embedded in document.mi');
select has_column('core', 'document', 'mi', 'BSA-09: mi_central_log.purchaser_id_number -> embedded in document.mi');

-- BSA-10 Travel Rule (Wires ≥$3,000)  (in-scope fields: 10, gaps: 0, out-of-scope: 0)
...
-- BSA-17 High-Risk Categories (MSB, Correspondent, Private Banking)  (in-scope fields: 5, gaps: 0, out-of-scope: 6)
select has_column('core', 'document', 'edd', 'BSA-17: edd_file.approver_id -> embedded in document.edd');
select has_column('core', 'document', 'edd', 'BSA-17: edd_file.category_checklist -> embedded in document.edd');
select has_column('core', 'document', 'edd', 'BSA-17: edd_file.msb_registration_number -> embedded in document.edd');
select has_column('core', 'document', 'edd', 'BSA-17: edd_file.site_visit_report -> embedded in document.edd');
select has_column('core', 'document', 'edd', 'BSA-17: edd_file.source_of_wealth -> embedded in document.edd');

-- BSA-18 PEP Screening & EDD  (in-scope fields: 4, gaps: 0, out-of-scope: 3)
...
-- BSA-20 Prepaid Access & Third-Party Vendors  (in-scope fields: 3, gaps: 0, out-of-scope: 7)
select has_column('core', 'document', 'vendor_alert', 'BSA-20: vendor_alert.alert_details -> embedded in document.vendor_alert');
select has_column('core', 'document', 'vendor_alert', 'BSA-20: vendor_alert.impact_scope -> embedded in document.vendor_alert');
select has_column('core', 'document', 'vendor', 'BSA-20: vendor_review.efficacy_results -> embedded in document.vendor');
...
-- BC-05 Monitoring, Detection, and Severity  (in-scope fields: 4, gaps: 0, out-of-scope: 2)
select has_column('core', 'incident', 'comms_plan', 'BC-05: incident.comms_plan -> incident.comms_plan');
select has_column('core', 'incident', 'ic_assignment_timer', 'BC-05: incident.ic_assignment_timer -> incident.ic_assignment_timer');
...
-- BC-06 Incident Declaration and Initial Actions  (in-scope fields: 3, gaps: 0, out-of-scope: 2)
select has_column('core', 'incident', 'contained', 'BC-06: incident.contained -> incident.contained');
...
-- BC-09 Major IT Failure Response  (in-scope fields: 2, gaps: 0, out-of-scope: 3)
select has_column('core', 'incident', 'ic_assignment_timer', 'BC-09: incident.ic_assignment_timer -> incident.ic_assignment_timer');
...
-- BC-15 Security/Privacy Incident Containment, Legal Consult & Vendor Coordination  (in-scope fields: 6, gaps: 0, out-of-scope: 6)
select has_column('core', 'incident', 'containment_timer', 'BC-15: incident.containment_timer -> incident.containment_timer');
...
-- BC-13 Post-Incident Review (PIR)  (in-scope fields: 3, gaps: 0, out-of-scope: 3)
...
-- CP-11 Training and Competency  (in-scope fields: 10, gaps: 1, out-of-scope: 1)
...
select todo('CP-11 gap: training.proficiency.failed -> training.proficiency_failed MISSING', 1);
select has_column('core', 'training', 'proficiency_failed');
...
-- CP-12 Monitoring, Reporting, and Recordkeeping  (in-scope fields: 1, gaps: 0, out-of-scope: 10)
...
select has_column('core', 'loan', 'well_secured_documented', 'CO-02: loan.well_secured_documented -> loan.well_secured_documented');
...
select has_column('core', 'loan', 'well_secured_documented', 'CO-03: loan.well_secured_documented -> loan.well_secured_documented');
...
-- CO-11 Collections-Data Incident Logging & Triage  (in-scope fields: 10, gaps: 0, out-of-scope: 0)
...
select has_column('core', 'incident', 'reportability_assessment', 'CO-11: incident.reportability_assessment -> incident.reportability_assessment');
select has_column('core', 'incident', 'reportability_determination', 'CO-11: incident.reportability_determination -> incident.reportability_determination');
...
-- CM-04 Compliance Risk Assessment  (in-scope fields: 2, gaps: 0, out-of-scope: 5)
...
-- CM-08 Regulatory Change and Complaint Management  (in-scope fields: 8, gaps: 0, out-of-scope: 6)
...
-- CM-09 Policy and CMS Review Cadence  (in-scope fields: 2, gaps: 0, out-of-scope: 12)
...
-- DF-09 Recordkeeping and Reporting  (in-scope fields: 4, gaps: 0, out-of-scope: 3)
...
-- DF-10 Training, Acknowledgment, and Enforcement  (in-scope fields: 3, gaps: 0, out-of-scope: 7)
...
-- EC-01 Safeguarding Member Information  (in-scope fields: 1, gaps: 0, out-of-scope: 6)
select has_column('core', 'finding', 'description', 'EC-01: finding.description -> finding.description');

-- EC-02 Network and Data Access Controls  (in-scope fields: 2, gaps: 0, out-of-scope: 12)
...
-- EC-06 Encryption  (in-scope fields: 3, gaps: 0, out-of-scope: 5)
...
-- EC-09 Security Monitoring, Penetration Testing, and Intrusion Detection  (in-scope fields: 2, gaps: 0, out-of-scope: 11)
...
-- EC-13 Breach Detection, Liability Assessment & External Comms Gating  (in-scope fields: 9, gaps: 0, out-of-scope: 1)
...
select has_column('core', 'incident', 'reportability_assessment', 'EC-13: incident.reportability_assessment -> incident.reportability_assessment');
...
-- EPS-01 Planning and Feasibility Analysis  (in-scope fields: 1, gaps: 0, out-of-scope: 6)
...
-- EPS-05 Authentication Controls  (in-scope fields: 2, gaps: 0, out-of-scope: 9)
...
-- EPS-06 Dual Control for High-Risk Processes  (in-scope fields: 4, gaps: 0, out-of-scope: 12)
select has_column('core', 'ach_transfer', 'amount', 'EPS-06: ach_transfer.amount -> ach_transfer.amount');
select has_column('core', 'ach_transfer', 'control_results', 'EPS-06: ach_transfer.control_results -> ach_transfer.control_results');
...
-- ERM-04 Risk Assessment & Register Maintenance  (in-scope fields: 14, gaps: 0, out-of-scope: 1)
...
select has_column('core', 'risk', 'registered', 'ERM-04: risk.registered -> risk.registered');
...
select has_column('core', 'risk', 'review_overdue', 'ERM-04: risk.review_overdue -> risk.review_overdue');
...
-- ERM-07 Risk Acceptance & Exceptions  (in-scope fields: 3, gaps: 0, out-of-scope: 9)
...
-- FL-12 Record Retention  (in-scope fields: 1, gaps: 0, out-of-scope: 3)
...
-- IS-06 Access Control and Authentication  (in-scope fields: 2, gaps: 0, out-of-scope: 14)
...
-- IC-05 Access and Change Controls  (in-scope fields: 9, gaps: 0, out-of-scope: 10)
...
-- IC-06 Exception and Override Management  (in-scope fields: 1, gaps: 0, out-of-scope: 11)
...
-- IP-02 Governance, Board Oversight, and Delegations  (in-scope fields: 5, gaps: 0, out-of-scope: 8)
...
select has_column('core', 'trade', 'limit_blocked', 'IP-02: trade.limit.blocked -> trade.limit_blocked');
select has_column('core', 'trade', 'settlement_amount', 'IP-02: trade.settlement_amount -> trade.settlement_amount');

-- IP-03 Permissible Investments and Prohibited Activities  (in-scope fields: 4, gaps: 0, out-of-scope: 4)
select has_column('core', 'trade', 'blocked_prohibited', 'IP-03: trade.blocked_prohibited -> trade.blocked_prohibited');
select has_column('core', 'trade', 'instrument_type', 'IP-03: trade.instrument_type -> trade.instrument_type');
select has_column('core', 'trade', 'limit_blocked', 'IP-03: trade.limit.blocked -> trade.limit_blocked');
select has_column('core', 'trade', 'permissibility', 'IP-03: trade.permissibility -> trade.permissibility');

-- IP-05 Credit Risk Standards and Downgrade Management  (in-scope fields: 2, gaps: 0, out-of-scope: 6)
select has_column('core', 'trade', 'instrument_type', 'IP-05: trade.instrument_type -> trade.instrument_type');
select has_column('core', 'trade', 'limit_blocked', 'IP-05: trade.limit.blocked -> trade.limit_blocked');

-- IP-07 Concentration and Counterparty Limits  (in-scope fields: 1, gaps: 0, out-of-scope: 6)
select has_column('core', 'trade', 'limit_blocked', 'IP-07: trade.limit.blocked -> trade.limit_blocked');

-- IP-08 Approved Brokers, Dealers, and Safekeepers  (in-scope fields: 2, gaps: 0, out-of-scope: 5)
select has_column('core', 'trade', 'intermediary_blocked', 'IP-08: trade.intermediary.blocked -> trade.intermediary_blocked');
select has_column('core', 'trade', 'intermediary_id', 'IP-08: trade.intermediary_id -> trade.intermediary_id');

-- IP-11 Pre-Purchase Due Diligence and Exceptions  (in-scope fields: 4, gaps: 0, out-of-scope: 1)
select has_column('core', 'trade', 'checklist_exception_raised', 'IP-11: trade.checklist_exception_raised -> trade.checklist_exception_raised');
...
-- IP-14 Trade Execution, Controls, and Segregation of Duties  (in-scope fields: 7, gaps: 0, out-of-scope: 1)
select has_column('core', 'trade', 'confirmation_matched', 'IP-14: trade.confirmation_matched -> trade.confirmation_matched');
select has_column('core', 'trade', 'reconciliation_due_at', 'IP-14: trade.reconciliation.due_at -> trade.reconciliation_due_at');
select has_column('core', 'trade', 'sod_blocked', 'IP-14: trade.sod.blocked -> trade.sod_blocked');
...
select has_column('core', 'document', 'attachment_due_at', 'IP-15: document.attachment_due_at -> document.attachment_due_at');
select has_column('core', 'document', 'retention_schedule', 'IP-15: document.retention_schedule -> document.retention_schedule');
select has_column('core', 'document', 'subject_ref', 'IP-15: document.subject_ref -> document.subject_ref');
select has_column('core', 'document', 'type', 'IP-15: document.type -> document.type');
...
-- LP-11 OFAC & Sanctions Gate  (in-scope fields: 6, gaps: 0, out-of-scope: 3)
...
select has_column('core', 'loan_application', 'parties', 'LP-11: loan_party.ofac_potential_match -> embedded in loan_application.parties');
...
-- MP-01 Membership Eligibility and Onboarding  (in-scope fields: 8, gaps: 0, out-of-scope: 4)
...
-- MP-02 Account Maintenance and Change of Address  (in-scope fields: 6, gaps: 0, out-of-scope: 8)
...
-- MP-06 Member Expulsion  (in-scope fields: 2, gaps: 0, out-of-scope: 9)
...
-- MP-07 Member Death and Estate Handling  (in-scope fields: 3, gaps: 0, out-of-scope: 9)
...
-- PR-02 Opt-Out Capture and Honoring  (in-scope fields: 2, gaps: 0, out-of-scope: 9)
...
-- PR-04 Member Access and Authentication  (in-scope fields: 1, gaps: 0, out-of-scope: 8)
select has_column('core', 'entity', 'id', 'PR-04: entity.id -> entity.id');

-- PR-05 Data Accuracy and Corrections  (in-scope fields: 4, gaps: 0, out-of-scope: 5)
...
-- PR-06 Employee Access Minimization and Training  (in-scope fields: 5, gaps: 0, out-of-scope: 7)
...
-- PR-08 Secure Disposal of NPPI  (in-scope fields: 2, gaps: 0, out-of-scope: 13)
...
-- PR-18 Incident Detection, Classification & SAR Referral  (in-scope fields: 11, gaps: 0, out-of-scope: 0)
select has_column('core', 'incident', 'contained', 'PR-18: incident.contained -> incident.contained');
...
select has_column('core', 'incident', 'sar_referred', 'PR-18: incident.sar_referred -> incident.sar_referred');
...
-- PR-11 Website Posting and E-SIGN Delivery  (in-scope fields: 1, gaps: 0, out-of-scope: 7)
select has_column('core', 'entity', 'id', 'PR-11: entity.id -> entity.id');

-- PR-12 State Privacy Rights: Universal Floor  (in-scope fields: 2, gaps: 0, out-of-scope: 8)
...
-- PR-15 Third-Party App and Account Connections  (in-scope fields: 1, gaps: 0, out-of-scope: 6)
select has_column('core', 'entity', 'id', 'PR-15: entity.id -> entity.id');

-- PR-16 Biometric Data for KYC  (in-scope fields: 8, gaps: 0, out-of-scope: 0)
...
select has_column('core', 'verification', 'biometric_declined', 'PR-16: verification.biometric.declined -> verification.biometric_declined');
...
select has_column('core', 'verification', 'biometric_consent_id', 'PR-16: verification.biometric_consent_id -> verification.biometric_consent_id');
select has_column('core', 'verification', 'biometric_purged', 'PR-16: verification.biometric_purged -> verification.biometric_purged');
...
-- RR-05 Legal Holds  (in-scope fields: 7, gaps: 0, out-of-scope: 4)
...
select has_column('core', 'legal_hold', 'schedule_resumed', 'RR-05: legal_hold.schedule_resumed -> legal_hold.schedule_resumed');
...
-- RII-03 Mandatory Indemnification  (in-scope fields: 9, gaps: 1, out-of-scope: 2)
...
select todo('RII-03 gap: indemnification.payment.disbursed -> indemnification.payment_disbursed MISSING', 1);
select has_column('core', 'indemnification', 'payment_disbursed');
...
select has_column('core', 'indemnification', 'request', 'RII-03: indemnification.request.routed -> indemnification.request');

-- RII-04 Permissive Indemnification  (in-scope fields: 12, gaps: 3, out-of-scope: 2)
...
select todo('RII-04 gap: indemnification.payment.blocked -> indemnification.payment_blocked MISSING', 1);
select has_column('core', 'indemnification', 'payment_blocked');
select todo('RII-04 gap: indemnification.payment.disbursed -> indemnification.payment_disbursed MISSING', 1);
select has_column('core', 'indemnification', 'payment_disbursed');
...
select has_column('core', 'indemnification', 'request', 'RII-04: indemnification.request.routed -> indemnification.request');
select todo('RII-04 gap: indemnification.standard_determination.made -> indemnification.standard_determination_made MISSING', 1);
select has_column('core', 'indemnification', 'standard_determination_made');

-- RII-05 Advancement of Expenses  (in-scope fields: 7, gaps: 2, out-of-scope: 2)
select todo('RII-05 gap: indemnification.advance.disbursed -> indemnification.advance_disbursed MISSING', 1);
select has_column('core', 'indemnification', 'advance_disbursed');
...
select todo('RII-05 gap: indemnification.repayment.demanded -> indemnification.repayment_demanded MISSING', 1);
select has_column('core', 'indemnification', 'repayment_demanded');
...
-- RII-06 Indemnification Exclusions  (in-scope fields: 4, gaps: 1, out-of-scope: 0)
...
select todo('RII-06 gap: indemnification.payment.blocked -> indemnification.payment_blocked MISSING', 1);
select has_column('core', 'indemnification', 'payment_blocked');
...
select has_column('core', 'indemnification', 'decision_body', 'RII-07: indemnification.decision_body.selected -> indemnification.decision_body');
...
select has_column('core', 'indemnification', 'request', 'RII-07: indemnification.request.routed -> indemnification.request');

-- RII-08 Claims Procedures  (in-scope fields: 0, gaps: 1, out-of-scope: 6)
select todo('RII-08 gap: indemnification.claim.notified -> indemnification.claim_notified MISSING', 1);
select has_column('core', 'indemnification', 'claim_notified');

-- RII-09 Recordkeeping  (in-scope fields: 3, gaps: 0, out-of-scope: 9)
...
-- TIS-05 Periodic Statement Disclosures  (in-scope fields: 2, gaps: 0, out-of-scope: 5)
...
-- TIS-06 Interest Calculation  (in-scope fields: 2, gaps: 0, out-of-scope: 6)
...
-- TIS-08 Overdraft Service Disclosures  (in-scope fields: 3, gaps: 0, out-of-scope: 4)
...
-- TIS-09 Recordkeeping  (in-scope fields: 1, gaps: 0, out-of-scope: 6)
