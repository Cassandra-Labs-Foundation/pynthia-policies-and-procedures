...
**ALERTS/METRICS:** Alert fires if any integrity test fails; target zero failures without same-day CCO notification and investigation. Dashboard metric: count of records approaching retention expiry by class, reviewed monthly by the Records function. Hold, disposal, and permanent-record alerts are governed by [SC-02](#sc-02-record-retention-lifecycle-mechanics).
