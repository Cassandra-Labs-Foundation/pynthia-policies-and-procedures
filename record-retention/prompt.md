...
- **GLBA, FCRA, and IRS retention rules** — Privacy, consumer-report, and tax-record retention requirements. IRS statute of limitations is generally 3 years but extends to 6 years where income is underreported by more than 25%; no limit applies in cases of fraud or failure to file.
- **California Franchise Tax Board (FTB)** — 4-year SOL for California income and franchise tax assessments; records must be sufficient to reconstruct any return subject to examination.
- **ERISA (29 U.S.C. § 1027)** — 6-year retention of employee benefit plan records sufficient to determine benefits due.
- **FFIEC Third-Party Risk Management Guidance** — Vendor due diligence and contract records retained for the life of the relationship plus at least 3 years after termination.
...
**(j) BSA/AML Anonymization and Extended Analytical Retention.** After the 5-year BSA/AML retention period, individually identifiable customer information is destroyed or anonymized in accordance with CPRA standards. Anonymized and aggregated BSA/AML data (from which no individual can be identified) may be retained beyond 5 years for compliance analytics, trend analysis, and program improvement purposes. Retention of anonymized data must be documented, and the anonymization process must meet the CPRA de-identification standard (reasonable measures taken to prevent re-identification; public commitment not to re-identify). The audit trail must record when anonymization occurred so that examiners can confirm the disposition of individually identifiable records even when older data cannot be traced to specific customers.

**(k) CDD Refresh Cycle and Stale-Record Disposition.** Customer Due Diligence (CDD) records are refreshed on a rolling basis: at minimum annually for higher-risk customers, every two years for standard-risk customers, and upon any new product or service added to a customer relationship. Upon refresh, superseded CDD records are evaluated: information that has been updated or replaced is destroyed or anonymized (consistent with section (j) above) rather than carried forward, ensuring that only current, accurate customer information is maintained. The BSA department must document the refresh date, the triggering event (scheduled review or new product), and the disposition of superseded records in the customer file. This cycle supports both BSA program integrity and CPRA data minimization obligations by systematically eliminating stale personal information.

**(l) Institutional and Corporate Records — Retention Schedule.** Schedule A must include a dedicated institutional-records section covering the following categories, with periods reflecting the longer of the applicable federal/state requirement and Pynthia's conservative default. Where a range appears in the source reference, use the longer end.

**Permanent records** (no scheduled destruction date; stored in secure, retrievable format indefinitely):
...
**Corporate governance records** (10 years or longer):
...
**Tax records** (7 years, covering the IRS 6-year underreporting SOL plus a 1-year buffer; California FTB 4-year SOL is fully covered):
...
**Audit and examination records** (5 years — resolves the discrepancy in the source reference between the "4 years" entry in Risk Management and the "5 years" entry in Accounting; the longer period governs):
...
- BSA/AML compliance program documentation — 5 years (consistent with 31 CFR §1010.430)
...
**Vendor and contract records** (life of agreement plus 3 years after termination, consistent with FFIEC third-party risk guidance):
- Vendor files, contracts, and due diligence records — 3 years after end of agreement (or longer if the relationship is subject to a legal hold or regulatory inquiry)
- Federal funds line and other borrowing agreements — 3 years after close

**HR and employment records**:
- ERISA benefit plan documents and reports — 6 years after plan closure (per 29 U.S.C. § 1027)
...
- Payroll records, deductions, and overtime records — 3 years (FLSA minimum)
- Salary records — 5 years
- OSHA Forms 100/101/102 — 5 years

**Permanent-record governance.** Permanent records must be inventoried in Schedule A with a "Permanent" destruction date, stored in a secure and retrievable format, and excluded from all routine destruction runs. The SVP of Operations & Finance must confirm the permanent-record inventory annually and report any gaps to the Board.
