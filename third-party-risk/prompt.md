...
and Privacy. Before generating, read
...
Do not renumber this control into the TR-xx sequence, do not retitle it,
...
This policy's own vendor-notification SLA, internal triage, and SAR
referral is **not** part of SC-01. Emit it as its own separate,
normally-numbered control in this policy's TR-xx sequence (next available
number), titled along the lines of "Vendor Incident Notification, Internal
Triage & SAR Referral," and have its SYSTEM BEHAVIOR note that it feeds
