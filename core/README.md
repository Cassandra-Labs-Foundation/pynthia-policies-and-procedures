...
`compliance-floor.yaml` into `targets.json` (767 targets: 369 contract, 333 control,
...
What drill does *not* cover is verifier's other **434** targets — 369 contract (error
