...
- `control:CP-10` — controls.json CP-10 (capitalization) — Internal Capital Adequacy Assessment (ICAAP)
...
- `control:CA-02` — controls.json CA-02 (cash) — Scope and Applicability
- `control:CA-11` — controls.json CA-11 (cash) — Training and Competency
