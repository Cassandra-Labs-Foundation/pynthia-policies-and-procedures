...
E-Commerce, Electronic Payment Systems, Collections, Privacy, and
...
Do not renumber this control into the IS-xx sequence, do not retitle it,
...
This policy's own incident declaration, IC assignment/first-hour checklist,
and post-mortem material is **not** part of SC-01. Emit it as its own
separate, normally-numbered control in this policy's IS-xx sequence (next
available number), titled along the lines of "Incident Declaration, IC
